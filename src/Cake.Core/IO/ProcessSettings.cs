...
namespace Cake.Core.IO
{
    ...
    public sealed class ProcessSettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to enable events to be emitted by the process.
        /// </summary>
        public bool EnableRaisingEvents { get; set; }

        /// <summary>
        /// Gets or sets search paths for files, directories for temporary files, application-specific options, and other similar
        /// information.
        /// </summary>
        /// <value>
