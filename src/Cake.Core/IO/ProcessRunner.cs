...
namespace Cake.Core.IO
{
    ...
    public sealed class ProcessRunner : IProcessRunner
    {
        ...
        public IProcess Start(FilePath filePath, ProcessSettings settings)
        {
            ...
            var process = new Process { StartInfo = info, EnableRaisingEvents = settings.EnableRaisingEvents };

            var wrapper = new ProcessWrapper(process, _log, arguments.FilterUnsafe);
